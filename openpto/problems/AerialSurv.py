...
FEATURE_COLS = [
    "lat", "long", "month_indicator", "timestep_feat",
    "prev_counts_05back", "prev_counts_04back", "prev_counts_03back",
    "prev_counts_02back", "prev_counts_01back",
]
TARGET_COL = "counts"
...
class AerialSurv(PTOProblem):
    """Aerial surveillance top-K problem.

    Each instance is a timestep; the task is to select the K=50 locations
    (out of 1338) with the highest predicted counts.

    Data: 15 train / 6 val / 6 test timesteps. Fixed real-world splits.
